...
ss = m2.stream.Stream()
ss.append(m2.note.Note(35))
ss.append(m2.note.Note(36))
ss.append(m2.note.Note(38))
mf = m2.midi.translate.streamToMidiFile(ss)
for track in mf.tracks:
	for e in track.events:
		e.channel = 10

mf.open(f'assets/try.mid', 'wb')
mf.write()
mf.close()
...
aPart0.write('midi', fp='tuto_drumsnotes.mid')
from utils import *
synthaudio(aPart0, "try")
Logging.info('tuto_drumsnotes.mid written.')